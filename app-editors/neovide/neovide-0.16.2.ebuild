...
SKIA_VERSION="0.93.1"
SKIA_COMMIT="319323662b1685a112f5"

SRC_URI="
	https://codeload.github.com/neovide/neovide/tar.gz/refs/tags/${PV} -> ${P}.tar.gz
	amd64? ( https://github.com/rust-skia/skia-binaries/releases/download/${SKIA_VERSION}/skia-binaries-${SKIA_COMMIT}-x86_64-unknown-linux-gnu-egl-gl-jpegd-jpege-pdf-svg-textlayout-wayland-x11.tar.gz -> skia-binaries-${SKIA_VERSION}-amd64.tar.gz )
	arm64? ( https://github.com/rust-skia/skia-binaries/releases/download/${SKIA_VERSION}/skia-binaries-${SKIA_COMMIT}-x86_64-unknown-linux-gnu-egl-gl-jpegd-jpege-pdf-svg-textlayout-wayland-x11.tar.gz -> skia-binaries-${SKIA_VERSION}-arm64.tar.gz )
	${CARGO_CRATE_URIS}
"
LICENSE="
