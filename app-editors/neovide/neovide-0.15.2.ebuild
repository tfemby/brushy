...
SKIA_COMMIT="38fd2e759f27f399c0c5"

SRC_URI="
	https://codeload.github.com/neovide/neovide/tar.gz/refs/tags/${PV} -> ${P}.tar.gz
	amd64? ( https://github.com/rust-skia/skia-binaries/releases/download/${SKIA_VERSION}/skia-binaries-${SKIA_COMMIT}-x86_64-unknown-linux-gnu-egl-gl-pdf-svg-textlayout-wayland-x11.tar.gz -> skia-binaries-${SKIA_VERSION}-amd64.tar.gz )
	arm64? ( https://github.com/rust-skia/skia-binaries/releases/download/${SKIA_VERSION}/skia-binaries-${SKIA_COMMIT}-aarch64-unknown-linux-gnu-egl-gl-pdf-svg-textlayout-wayland-x11.tar.gz -> skia-binaries-${SKIA_VERSION}-arm64.tar.gz )
	${CARGO_CRATE_URIS}
"
LICENSE="
