...
src_prepare() {
	...
	# Applies all of the patches within master branch
	eapply "${FILESDIR}/00_2025_master_branch.patch"

	# This module hasn't upgraded to the c23 standard yet. Specify GCC to use `-std=gnu17` instead
	# https://wiki.gentoo.org/wiki/Modern_C_porting
	# https://github.com/bucardo/dbdpg/issues/135
	eapply "${FILESDIR}/01_std_gnu17_dirty_hack.patch"
